...
class CategoriaContableResource extends Resource
{
    ...
    {
        return [
            \App\Resources\CategoriaContableResource\RelationManagers\HijosRelationManager::class,
        ];
    }
    ...
    {
        return [
            'index'  => \App\Resources\CategoriaContableResource\Pages\ListCategoriaContable::route('/'),
            'create' => \App\Resources\CategoriaContableResource\Pages\CreateCategoriaContable::route('/create'),
            'edit'   => \App\Resources\CategoriaContableResource\Pages\EditCategoriaContable::route('/{record}/edit'),
        ];
    }
}