...
class CurrencyResource extends Resource
{
    ...
    {
        return [
            'index'  => \App\Resources\CurrencyResource\Pages\ListCurrencies::route('/'),
            'create' => \App\Resources\CurrencyResource\Pages\CreateCurrency::route('/create'),
            'edit'   => \App\Resources\CurrencyResource\Pages\EditCurrency::route('/{record}/edit'),
        ];
    }
}